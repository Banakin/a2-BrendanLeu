...
- Form submits data
- Server creates start/end time stamps and infers total battle length in minutes
- Database displays
- Can create entries in database
- Can delete entries in database
- Can update entries in database
